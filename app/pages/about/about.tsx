        ...
        <main>
            ...
            <div className="font-sans text-white overflow-x-hidden">
                ...
                <section className='relative pt-40 pb-20 overflow-hidden'>
                    <SectionBackground variant="about" intensity="high" />
                ...
                <section id="about-section" className="py-24 relative overflow-hidden">
                    <SectionBackground variant="about" intensity="medium" />
                    <div className="container relative z-10">
                        ...
                        <div ref={storySectionRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div
                                className={`flex flex-col justify-between bg-[#111] border border-[#d4af37]/10 rounded-2xl p-6 hover:border-[#d4af37]/30 transition-[opacity,transform] duration-700 ease-out group ${
                            ...
                            <div
                                className={`flex flex-col justify-between bg-[#111] border border-[#d4af37]/10 rounded-2xl p-6 hover:border-[#d4af37]/30 transition-[opacity,transform] duration-700 ease-out delay-150 group ${
                                    storyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                                }`}
                            >
                                <div>
                            ...
                            <div
                                className={`flex flex-col justify-between bg-[#111] border border-[#d4af37]/10 rounded-2xl p-6 hover:border-[#d4af37]/30 transition-[opacity,transform] duration-700 ease-out delay-300 group ${
                                    storyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                                }`}
                            >
                                <div>
                ...
                <section className="py-16 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[85%] max-w-4xl h-[1px] bg-gradient-to-r from-transparent via-[#d4af37]/25 to-transparent z-10" />
                    <SectionBackground variant="about" intensity="subtle" floatingElements={false} />
                    <div className="container relative z-10">
                ...
                <section className="py-24 relative overflow-hidden">
                    <SectionBackground variant="services" pattern="grid" intensity="medium" />
                    <div className="container relative z-10">
                        <header className="mx-auto max-w-2xl text-center section-header scroll-animate">
