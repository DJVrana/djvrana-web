...
export function meta({ params }: Route.MetaArgs) {
  ...
  return getMultilingualMeta(
    "dj-edukacija", 
    m.dj_education_meta_title({}, { locale }), 
    m.dj_education_meta_desc({}, { locale }),
    m.dj_education_meta_keywords({}, { locale }),
    locale
  );
}
  ...
  return (
    <main>
      ...
      <div className="min-h-screen text-white font-sans overflow-x-hidden">
        ...
        <section className="text-center mb-16 relative dj-education-hero-bg-img py-30 md:py-40 px-4 overflow-hidden">
        ...
        <section className='dj-education relative py-12 md:py-20 px-4 md:px-0 overflow-hidden'>
