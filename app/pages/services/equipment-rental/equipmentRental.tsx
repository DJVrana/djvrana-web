  ...
  return (
    <main>
      ...
      <div className="min-h-screen text-white font-sans overflow-x-hidden">
        ...
        <section className="text-center mb-16 relative equipment-rental-hero-bg-img py-30 md:py-40 px-4 overflow-hidden">
        ...
        <section className='equipment-rental relative py-12 md:py-20 px-4 md:px-0 overflow-hidden'>
