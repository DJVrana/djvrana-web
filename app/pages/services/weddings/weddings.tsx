...
export default function Vjencanja() {
  ...
  return (
    <main>
        ...
        <section className="text-center mb-16 relative wedding-hero-bg-img py-30 md:py-40 px-4 overflow-hidden">
        ...
        <section className='wedding relative py-12 md:py-20 px-4 md:px-0 overflow-hidden'>
