...
export const links: Route.LinksFunction = () => [
  ...
  { rel: "icon", type: "image/png", sizes: "96x96", href: "/djvrana-web/favicon-96x96.png" },
  { rel: "icon", type: "image/svg+xml", href: "/djvrana-web/favicon.svg" },
  { rel: "shortcut icon", href: "/djvrana-web/favicon.ico" },
  { rel: "apple-touch-icon", sizes: "180x180", href: "/djvrana-web/apple-touch-icon.png" },
